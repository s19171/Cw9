    ...
    public class LinqSamples
    {
        ...
        */
        ...
        public void Przyklad1()
        {
            ...
            var re2 = Emps.Where(x => x.Job == "Backend programmer").Select(x => new
            {
                Nazwisko = x.Ename,
                Zawod = x.Job
            });
        ...
        public void Przyklad2()
        {
            var res2 = Emps.Where(x => x.Job == "Frontend programmer" && x.Salary > 1000).Select(x => new
            {
                ...
                Zawod = x.Job,
                Salary = x.Salary
            }).OrderByDescending(x => x.Nazwisko);
        ...
        public void Przyklad4()
        {
            var salary = from emp in Emps
                       select emp.Salary;
            var res = Emps.Where(x => x.Salary == salary.Max()).Select(x => new
            {
                Nazwisko = x.Ename,
                Zawod = x.Job,
                Salary = x.Salary
        ...
        {
            Console.WriteLine(Emps.Any(x => x.Job == "Backend programmer"));
        }
